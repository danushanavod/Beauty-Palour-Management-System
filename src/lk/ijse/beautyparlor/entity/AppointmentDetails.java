...
public class AppointmentDetails {
    ...
    public AppointmentDetails(String appointmentDetailsId, String appointmentId, String serviceId) {
    ...
    public String toString() {
        return "AppointmentDetails{" + "appointmentDetailsId=" + appointmentDetailsId + ", appointmentId=" + appointmentId + ", serviceId=" + serviceId + '}';
    }
