...
public class Payments {
    ...
    public Payments(String paymentId, String date, double appointmentCharge, double stylistCharge, double bridalCharge, double rentCharge, String method, double fullAmount) {
    ...
    public String toString() {
        return "Payments{" + "paymentId=" + paymentId + ", date=" + date + ", appointmentCharge=" + appointmentCharge + ", stylistCharge=" + stylistCharge + ", bridalCharge=" + bridalCharge + ", rentCharge=" + rentCharge + ", method=" + method + ", fullAmount=" + fullAmount + '}';
    }
