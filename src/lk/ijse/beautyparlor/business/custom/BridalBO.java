 ...
 * @author ASUS
 */
public interface BridalBO extends SuperBO{
    public boolean addStylist(StylistDTO stylist) throws Exception;
    public boolean deleteStylist(String stylistId) throws Exception;
    ...
    public ArrayList<StylistDTO> allStylists() throws Exception;
    public ArrayList<String> allStylistIds() throws Exception;
